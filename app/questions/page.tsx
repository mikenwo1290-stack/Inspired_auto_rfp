    ...
    const interval = setInterval(() => {
      if (processed >= allQuestionIds.length) {
        ...
        toast({
          ...
          description: `Generated ${allQuestionIds.length} answers successfully.`,
        });
        return;
      }
      ...
      // Update the answer after a short delay
      setTimeout(() => {
        handleAnswerChange(questionId, mockAnswer);
        setIsGenerating(prev => ({ ...prev, [questionId]: false }));
      }, 300);
                        ...
                        {section.questions.map((question) => (
                            <div key={question.id} className="border-t pt-4 first:border-t-0 first:pt-0">
                              ...
                              <div className="relative">
                                ...
                                <button
                                  type="button"
                                  className="absolute top-2 right-2 p-1.5 rounded-md bg-blue-50 text-blue-600 hover:bg-blue-100 transition-colors"
